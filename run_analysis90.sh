...
#SBATCH --output=output_run90.txt
#SBATCH --error=error_run90.txt
...
set echo
  ...
  percentile=95
  region="US"
  case="${name}_P${percentile}_${region}_detrended_object_3days"
  ...
  python3 4_analysis_regimes_LE_allHWdays.py --name $name --name_land $name_land --case $case --region $region --path_case $path_case_land --path_case_land $path_case_land --path_file_SMs $path_file_SMs --path_file_t $t_file --path_file_t_anom $t_file_anoma --initial_year $initial_year --path_outputs $path_outputs_land
  ...
  python3 4_analysis_regimes_LE_allHWdays_conditional_regional.py --name $name --name_land $name_land --case $case --region $region --path_case $path_case_land --path_case_land $path_case_land --path_file_SMs $path_file_SMs --path_file_t $t_file --path_file_t_anom $t_file_anoma --initial_year $initial_year --path_outputs $path_outputs_land

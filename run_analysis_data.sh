...
#SBATCH --output=output_run_data.txt
#SBATCH --error=error_run_data.txt
...
set echo
  ...
  # python3 0_data.py --name_land $name_land --path_data $path_data_land --path_outputs $path_outputs_land --path_temp $path_outputs_land --initial_year $initial_year
  ...
  python3 4_analysis_regimes_LE_allHWdays_individual.py --name $name --name_land $name_land --case $case --region $region --path_case $path_case_land --path_case_land $path_case_land --path_file_SMs $path_file_SMs --path_file_t $t_file --path_file_t_anom $t_file_anoma --initial_year $initial_year --path_outputs $path_outputs_land
  # python3 4_analysis_regimes_LE_allsummer_conditional_regional.py --name $name --name_land $name_land --case $case --region $region --path_case $path_case_land --path_case_land $path_case_land --path_file_SMs $path_file_SMs --path_file_t $t_file --path_file_t_anom $t_file_anoma --initial_year $initial_year --path_outputs $path_outputs_land
  ...
  # environment=/home/castanev/.conda/envs/2024.02-py311/env_ncl
  # conda activate $environment
  # export PATH=$environment/bin:$PATH

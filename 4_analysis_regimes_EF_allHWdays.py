...
density_cache_path = (
    ...
    f'summer_allHWdays_05deg_{name_land}_{region}.npz'
)
...
def _plot_density_panel(
    ...
    ax.set_ylabel(r"EF (W m$^{-2}$)", fontsize=12)
...
for lag_days in lags_days:
    ...
    _plot_density_panel(
        ...
        title=(
            "SM vs EF — weak coupling (dominant regime 0 in ±0.5° box)\n"
            "Models 0 + weak option 1"
        ),
        outfile=(
            f"{path_figures}density_{variable_LE}_{variable_sm}_absSM_summer_allHWdays_"
    ...
    _plot_density_panel(
        ...
        title=(
            "SM vs EF — weak coupling (dominant regime 0 in ±0.5° box)\n"
            "Summer climatology only"
        ),
        outfile=(
            f"{path_figures}density_{variable_LE}_{variable_sm}_absSM_summerOnly_"
            f"05deg_weak_{name_land}_{region}.png"
        ),
        show_critical_vline=False,
        density_vmax=30,
        n_hw_events=n_hw_weak,
        show_hw_contours=False,
    )
    ...
    _plot_density_panel(
        ...
        xlabel=r"SMs (regional mean, ±0.5°)",
        title=(
            "SM vs EF — transitional (dominant regime 1 or 2 in ±0.5° box)\n"
            "Strong option 1 + LHS-flat"
        ),
        outfile=(
            f"{path_figures}density_{variable_LE}_{variable_sm}_absSM_summer_allHWdays_"
    ...
    _plot_density_panel(
        ...
        title=(
            "SM vs EF — moisture-limited (dominant regime 3 or 4 in ±0.5° box)\n"
            "RHS-flat / 3-segment breakpoints"
        ),
        outfile=(
            f"{path_figures}density_{variable_LE}_{variable_sm}_relBP_summer_allHWdays_"
    ...
    _plot_density_panel(
        ...
        outfile=(
            f"{path_figures}density_{variable_LE}_{variable_sm}_relBP_summerOnly_"
            f"05deg_moistlim_{name_land}_{region}.png"
        ),
        show_critical_vline=True,
        density_vmax=40,
    ...
    _plot_density_panel(
        ...
        title=(
            "SM vs EF — moisture-limited regime 3 (dominant in ±0.5° box)\n"
            "RHS-flat (2-segment) breakpoint"
        ),
        outfile=(
            f"{path_figures}density_{variable_LE}_{variable_sm}_relBP_summer_allHWdays_"
    ...
    _plot_density_panel(
        ...
        title=(
            "SM vs EF — moisture-limited regime 4 (dominant in ±0.5° box)\n"
            "3-segment breakpoint"
        ),
        outfile=(
            f"{path_figures}density_{variable_LE}_{variable_sm}_relBP_summer_allHWdays_"
